...
test.group('Check the number format', (group) => {
  test(`return invalid dial code when number is 09090`, ({ expect }) => {
    const response = PredictDigit('09090');

    expect(response).toBe('invalid dial code');
  });
  test(`return invalid dial code when number is 0987654312345`, ({ expect }) => {
    const response = PredictDigit('0987654312345');

    expect(response).toBe('invalid dial code');
  });
  test(`return invalid format when number is +2349056144059`, ({ expect }) => {
    const response = PredictDigit('+2349056144059');

    expect(response).toBe('invalid format');
  });
  test(`return invalid format when number is +23490238`, ({ expect }) => {
    const response = PredictDigit('+23490238');

    expect(response).toBe('invalid format');
  });
  test(`return invalid format when number is +234902389847329873292`, ({ expect }) => {
    const response = PredictDigit('+234902389847329873292');

    expect(response).toBe('invalid format');
  });
  test(`return invalid format when number is 783282`, ({ expect }) => {
    const response = PredictDigit('783282');

    expect(response).toBe('invalid format');
  });
  test(`return invalid format when number is +91838439833`, ({ expect }) => {
